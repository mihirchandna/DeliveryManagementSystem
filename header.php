        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="handover.php">Handover</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="deliveries_report.php">Delivery Report</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="handover_report.php">Handover Report</a>
                    </li>
                    <li class="nav-item">
